angular.module('BlurAdmin.common').directive("readfiledata", function ($filter, $rootScope) {
    return {
        scope: {
            opts: '=',
            uploader: '=',
        ...
        link: function ($scope, $elm, $attrs) {
            ...
            $elm.on('change', function (changeEvent) {
                ...
                fileType = fileName.substr(fileName.indexOf('.'));
                //.xls, xls
...
angular.module('BlurAdmin.common').directive('fileModel', ['$parse', function ($parse) {
    return {
        restrict: 'A',
