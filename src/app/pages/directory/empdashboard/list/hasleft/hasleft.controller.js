...
(function () {
    ...
    /** @ngInject */
    function hasLeftController($scope, param, $rootScope, $state, $stateParams, pageService, editFormService, $filter) {
        ...
        $scope.gridOptions = {
            ...
            columnDefs: [
                ...
                { name: 'RDRelievingDate', displayName: 'Has Left Date', width: 300, enableCellEdit: false },
            ],
        }
