...
(function () {
    ...
    angular.module('BlurAdmin.pages.directory.empdashboard')
        .controller('provisionalController', provisionalController);
    function provisionalController($scope, $rootScope, $state, $filter, pageService, createPdfReport) {
        var vm = this;
        $scope.entity = {};
        ...
        function _getSearchData() {
            if (!_validateApprovedData()) {
                ...
                var data = {
                    ...
                    reportType: 'Provisional Employee',
