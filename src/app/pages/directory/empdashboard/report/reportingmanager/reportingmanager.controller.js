...
(function () {
    ...
    angular.module('BlurAdmin.pages.directory.empdashboard')
        .controller('reportingManagerController', reportingManagerController);
        function reportingManagerController($scope, $rootScope, $state, $filter, pageService, createPdfReport) {
            var vm = this;
            $scope.entity = {};
