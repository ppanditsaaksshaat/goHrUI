...
(function () {
    ...
    angular.module('BlurAdmin.pages.employee.empfinances')
        .controller('empFinancesController', empFinancesController);

    /** @ngInject */
    function empFinancesController($scope, $rootScope,  $stateParams,fileReader, $filter, $uibModal, editFormService, pageService, dialogModal) {
