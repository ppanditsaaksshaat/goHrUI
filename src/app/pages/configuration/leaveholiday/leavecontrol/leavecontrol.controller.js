...
(function () {
    ...
    angular.module('BlurAdmin.pages.configuration.leaves.leavecontrol')
        .controller('leavecontrolController', leavecontrolController);

    /** @ngInject */
    function leavecontrolController($scope, $state, $stateParams, $rootScope,
        ...
        function _getTotalTenure() {
            ...
            if ($scope.entity.LRCNoOfDaysInCycle != undefined && $scope.entity.LRCCycleIntervalDays != undefined && $scope.entity.LRCCRDaysInInterval != undefined) {
                ...
                if (!isNaN($scope.entity.LRCCRDaysInInterval))
                    ...
                    $roopScope("error", "Please enter numeric value in Number Of Leave Field");
            }
        ...
        function _saveWizardFormSuccessResult(result) {
            ...
            $scope.showEditForm = false;
            $roopScope("success", "Record Saved Successfully");
        }
