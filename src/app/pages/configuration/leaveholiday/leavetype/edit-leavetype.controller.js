...
(function () {
    ...
    angular.module('BlurAdmin.pages.configuration.leaves.leavetype')
        .controller('leavetypeEditController', leavetypeEditController);

    /** @ngInject */
    function leavetypeEditController($scope, $rootScope, $state, $stateParams, pageService, editFormService, $filter) {
