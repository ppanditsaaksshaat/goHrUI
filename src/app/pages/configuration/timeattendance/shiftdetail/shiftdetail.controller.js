...
(function () {
    ...
    /** @ngInject */
    function shiftdetailController($scope, $state, $stateParams, $rootScope,
        pageService, editFormService) {
        ...
        $scope.$watch('entity.SMLunchTime', function (newVal, oldVal) {
            if (newVal) {
                ...
                // }
                // else {
                //   $rootScope.showMsg('warning', 'Lunch from time must be between shift timings.')
                ...
                if (toDiff > 0 && fromDiff > 0) {
                    if (!$scope.entity.SMLunchTime) {
                        ...
                        if (lunchDiff < 0) {
                            ...
                            $rootScope.showMsg('warning', 'Lunch To time can not be less than Lunch from time.')
        ...
        //         $rootScope.showMsg("warning", "duplicate record  " + groupName);
        //       }
