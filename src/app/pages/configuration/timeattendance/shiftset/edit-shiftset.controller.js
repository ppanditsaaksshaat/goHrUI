...
(function () {
    ...
    angular.module('BlurAdmin.pages.configuration.timeattendance.shiftset')
        .controller('shiftsetEditController', shiftsetEditController);

    /** @ngInject */
    function shiftsetEditController($scope, $rootScope, $state, $stateParams, pageService, editFormService, $filter) {
