...
(function () {
    ...
    angular.module('BlurAdmin.pages.configuration.company.locations.branch')
        .controller('branchEditController', branchEditController);

    /** @ngInject */
    function branchEditController($scope, $rootScope, $state, $stateParams, pageService, editFormService, $filter) {
