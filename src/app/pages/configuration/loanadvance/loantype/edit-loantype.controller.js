...
(function () {
    ...
    angular.module('BlurAdmin.pages.configuration.loanadvance.loantype')
        .controller('loantypeEditController', loantypeEditController);

    /** @ngInject */
    function loantypeEditController($scope, $rootScope, $state, $stateParams, pageService, editFormService, $filter) {
