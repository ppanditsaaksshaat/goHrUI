...
(function () {
    ...
    angular.module('BlurAdmin.pages.configuration.loanadvance.advancerule')
        .controller('advanceruleEditController', advanceruleEditController);

    /** @ngInject */
    function advanceruleEditController($scope, $rootScope, $state, $stateParams, pageService, editFormService, $filter) {
