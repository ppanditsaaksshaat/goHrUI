...
(function () {
    ...
    angular.module('BlurAdmin.pages.configuration.employee.retionsheep')
        .controller('retionsheepEditController', retionsheepEditController);

    /** @ngInject */
    function retionsheepEditController($scope, $rootScope, $state, $stateParams, pageService, editFormService, $filter) {
