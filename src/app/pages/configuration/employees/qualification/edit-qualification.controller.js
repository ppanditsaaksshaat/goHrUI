...
(function () {
    ...
    angular.module('BlurAdmin.pages.configuration.employee.qualification')
        .controller('qualificationEditController', qualificationEditController);

    /** @ngInject */
    function qualificationEditController($scope, $rootScope, $state, $stateParams, pageService, editFormService, $filter) {
