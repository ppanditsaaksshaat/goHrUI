...
(function () {
    ...
    angular.module('BlurAdmin.pages.configuration.employee.employeestatus')
        .controller('employeestatusEditController', employeestatusEditController);

    /** @ngInject */
    function employeestatusEditController($scope, $rootScope, $state, $stateParams, pageService, editFormService, $filter) {
