...
(function () {
    ...
    angular.module('BlurAdmin.pages.configuration.employee.employment')
        .controller('employmentEditController', employmentEditController);

    /** @ngInject */
    function employmentEditController($scope, $rootScope, $state, $stateParams, pageService, editFormService, $filter) {
