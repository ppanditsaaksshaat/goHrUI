...
(function () {
    ...
    angular.module('BlurAdmin.pages.configuration.employee.maritalstatus')
        .controller('maritalstatusEditController', maritalstatusEditController);

    /** @ngInject */
    function maritalstatusEditController($scope, $rootScope, $state, $stateParams, pageService, editFormService, $filter) {
