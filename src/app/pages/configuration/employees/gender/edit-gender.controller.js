...
(function () {
    ...
    angular.module('BlurAdmin.pages.configuration.employee.gender')
        .controller('genderEditController', genderEditController);

    /** @ngInject */
    function genderEditController($scope, $rootScope, $state, $stateParams, pageService, editFormService, $filter) {
