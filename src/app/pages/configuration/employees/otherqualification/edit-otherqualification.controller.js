...
(function () {
    ...
    angular.module('BlurAdmin.pages.configuration.employee.otherqualification')
        .controller('otherqualificationEditController', otherqualificationEditController);

    /** @ngInject */
    function otherqualificationEditController($scope, $rootScope, $state, $stateParams, pageService, editFormService, $filter) {
