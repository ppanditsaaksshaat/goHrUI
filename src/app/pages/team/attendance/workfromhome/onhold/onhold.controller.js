...
(function () {
    ...
    angular.module('BlurAdmin.pages.team.attendance.workfromhome.onhold')
        .controller('myTeamOnholdWFHController', myTeamOnholdWFHController);

    /** @ngInject */
    function myTeamOnholdWFHController($scope, $rootScope, pageService, editFormService) {
        ...
        function _loadController() {
            ...
            searchLists.push({ field: 'statusId', operand: '=', value: 106 })
        ...
        function _FindEntity(oldWFHApp, form) {
            ...
            function _findEntitySuccessResult(result) {
                ...
                if (oldWFHApp.StatusName == "approved") {
                    ...
                    entity.WAFHAdminReson = oldWFHApp.rejectReason;
                }
