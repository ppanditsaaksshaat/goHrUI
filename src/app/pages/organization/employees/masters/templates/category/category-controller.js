(function () {
    ...
    angular.module('BlurAdmin.pages.organization.masters')
        .controller('orgMasterCategoryController', orgMasterCategoryController);
    function orgMasterCategoryController($scope, $stateParams) {
        $scope.$on('designGrid', function (e) {
            $scope.setGrid(

                {
                    columns: ['CategoryName', 'CategoryDesc'],//list of columns
                    titleField: 'CategoryName',//first search field
