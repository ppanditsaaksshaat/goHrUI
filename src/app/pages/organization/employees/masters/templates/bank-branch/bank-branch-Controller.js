(function () {
    ...
    angular.module('BlurAdmin.pages.organization.masters')
        .controller('orgMasterBankBranchController1', orgMasterBankBranchController1);
    function orgMasterBankBranchController1($scope, $stateParams) {

        $scope.$on('designGrid', function (e) {
            $scope.setGrid(

                {
                    columns: ['BankName','BranchName','IFSCCode','BankPoatalZipCode'],//list of columns
                    titleField: 'BankName',//first search field
