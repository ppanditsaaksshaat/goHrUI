(function () {
    ...
    angular.module('BlurAdmin.pages.organization.masters')
        .controller('orgMasterGenderController', orgMasterGenderController);
    function orgMasterGenderController($scope, $stateParams) {
        $scope.$on('designGrid', function (e) {
            $scope.setGrid(

                {
                    columns: ['GenderName'],//list of columns
                    titleField: 'GenderName',//first search field
