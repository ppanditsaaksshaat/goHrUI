...
(function () {
    ...
    angular.module('BlurAdmin.pages.organization.masters')
        .controller('orgMasterMaritalController', orgMasterMaritalController);
    function orgMasterMaritalController($scope, $stateParams) {

        $scope.$on('designGrid', function (e) {
            $scope.setGrid(

                {
                    columns: ['MaritalName'],//list of columns
                    titleField: 'MaritalName',//first search field
