...
(function () {
    ...
    angular.module('BlurAdmin.pages.self.selfreport')
        .controller('reportLeaveStatementController', reportLeaveStatementController);
    function reportLeaveStatementController($scope, $rootScope, $state, $filter, pageService) {
        var vm = this;
