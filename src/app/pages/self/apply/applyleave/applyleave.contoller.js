...
(function () {
    ...
    /** @ngInject */
    function applyLeaveController($scope, $state, $stateParams,
      pageService, editableOptions, editableThemes, DJWebStore, dialogModal, editFormService, toastr, $filter, $timeout,$rootScope) {
