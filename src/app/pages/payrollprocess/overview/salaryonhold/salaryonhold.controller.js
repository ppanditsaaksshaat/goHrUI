...
(function () {
    ...
    angular.module('BlurAdmin.pages.payrollprocess.overview')
        .controller('salaryOnholdVerificationController', salaryOnholdVerificationController);

    /** @ngInject */
    function salaryOnholdVerificationController($scope, $rootScope, pageService, param) {
