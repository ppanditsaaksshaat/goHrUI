...
(function () {
  ...
  angular.module('BlurAdmin.pages.leave.applications')
    .controller('ApplicationsMastersListController', ApplicationsMastersListController);

  /** @ngInject */
  function ApplicationsMastersListController($scope, $stateParams, mailMessages, addModal, pageService, editableOptions, editableThemes) {
    var vm = this;
    ...
    $scope.templateUrl = function () {
      return "app/pages/leave/applications/templates/" + vm.tempFile + "/" + vm.tempFile + "-list.html"
    }
