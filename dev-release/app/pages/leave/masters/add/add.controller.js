...
(function () {
  ...
  angular.module('BlurAdmin.pages.leave.masters')
    .controller('LeaveMastersAddController1', LeaveMastersAddController1);

  /** @ngInject */
  function LeaveMastersAddController1($scope, $stateParams, $timeout, DJWebStore, pageService, editFormService) {
    var vm = this;
