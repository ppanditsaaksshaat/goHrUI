(function () {
    ...
    angular.module('BlurAdmin.pages.organization.masters')
        .controller('orgMasterEmpstatController', orgMasterEmpstatController);
    function orgMasterEmpstatController($scope, $stateParams) {
        $scope.$on('designGrid', function (e) {
            $scope.setGrid(

                {
                    columns: ['EmpStatusName'],//list of columns
                    titleField: 'EmpStatusName',//first search field
